<nav class="sidebar d-flex flex-column p-3">
            ...
            <ul class="nav nav-pills flex-column mb-auto ">
                <li><a href="hub.php" class="nav-link"><i class="fas fa-home me-2"></i>Início</a></li>
                <li><a href="./explorar.php" class="nav-link active"><i class="fas fa-compass me-2"></i>Explorar</a></li>
                <li><a href="./chat.php" class="nav-link d-flex justify-content-between align-items-center"><span><i class="fas fa-comment me-2"></i>Mensagens</span><span class="badge bg-danger">7</span></a></li>
                ...
                <li><a href="./notific.php" class="nav-link d-flex justify-content-between align-items-center"><span><i class="fas fa-bell me-2"></i>Notificações</span></a></li>
