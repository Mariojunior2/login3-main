...
<head>
  ...
  <style>
    :root { --red:#E10600; --yellow:#FFC107; --green:#28A745; --bg-dark:#121212; --card-bg:#1A1A1A; --text-secondary:#B0B0B0; }
    body { background: var(--bg-dark); color:#fff; }
    .sidebar { background:#000; width:260px; }
    .sidebar a.nav-link { color:#fff; padding:0.75rem 1rem; border-radius:0.5rem; }
    .sidebar a.nav-link.active, .sidebar a.nav-link:hover { background:var(--red); color:#fff; }
...
<div class="d-flex vh-100">
  ...
  <nav class="sidebar d-flex flex-column p-3">
    <a href="#" class="d-flex align-items-center mb-4 text-decoration-none">
      <span class="fs-4 text-danger me-1">Tydra</span><span class="fs-4">PI</span>
    </a>
